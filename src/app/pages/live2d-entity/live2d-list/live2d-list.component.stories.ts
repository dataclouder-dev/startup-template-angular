...
import { Live2dListComponent } from './live2d-list.component';
...
const meta: Meta<Live2dListComponent> = {
  title: 'Live2ds/Live2dListComponent',
...
export default meta;
type Story = StoryObj<Live2dListComponent>;
