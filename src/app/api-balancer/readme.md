...
- Usally is references in ApiBalancer Service, ToastAlertService, HttpService and Endpoints
- add endpints for ApiBalancers.

```
  ApiBalancers: {
    ApiBalancers: 'api/ApiBalancer',
    ApiBalancersFiltered: 'api/ApiBalancer/query',
  },
```
...
### 4) Starting building your collection table what every, change current IApiBalancer to your data bussiness.
