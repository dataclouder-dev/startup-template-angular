...
- Usally is references in DeckCommander Service, ToastAlertService, HttpService and Endpoints
- add endpints for DeckCommanders.
...
### 4) Starting building your collection table what every, change current IDeckCommander to your data bussiness.
